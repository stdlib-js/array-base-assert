...
```javascript
import { contains, hasSameValues, isAccessorArray, isComplex128Array, isComplex64Array } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert@deno/mod.js';
```
