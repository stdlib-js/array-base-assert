...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isAccessorArray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert@v0.0.1-deno/mod.js';
```
